...
function valueByChainId(rest, defaultValue) {
    ...
    return {
        ...
        [contract_addresses_1.ChainId.Base]: defaultValue,
        ...
        [contract_addresses_1.ChainId.ArbitrumRinkeby]: defaultValue,
...
function nativeWrappedTokenSymbol(chainId) {
    switch (chainId) {
        ...
        case contract_addresses_1.ChainId.PolygonMumbai:
            return 'WMATIC';
        case contract_addresses_1.ChainId.Avalanche:
            return 'WAVAX';
        case contract_addresses_1.ChainId.Fantom:
            return 'WFTM';
        case contract_addresses_1.ChainId.Celo:
            return 'CELO';
        default:
            return 'WETH';
    }
